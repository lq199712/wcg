...
<body>
	...
	<form class="form-horizontal" id="lbsForm" action="adminAction!update" method="post" onsubmit="return checkform();">
		...
		<div class="control-group">
	    	...
	    	<div class="controls">
	    	<s:if test="admin.ison==1">
	    		<input type="radio" name="admin.ison" value="1" checked="checked"/>启用&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="admin.ison" value="0"/>不启用
	    	</s:if>
	    	<s:else>
	    		<input type="radio" name="admin.ison" value="1"/>启用&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="admin.ison" value="0" checked="checked"/>不启用
	    	</s:else>
	    	</div>
	  	</div>
