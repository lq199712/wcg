...
#picsethere img {
	...
	<body style="height: 120%">
		...
		<form class="form-horizontal" id="lbsForm" action="renovationAction!update" method="post" enctype="multipart/form-data" onsubmit="return checkform();">
			
			<s:hidden name="renovation.id" title="人员子表自身id"></s:hidden>
			<s:hidden name="renovation.image1" title="整改前"></s:hidden>
			<s:hidden name="renovation.image2" title="整改后"></s:hidden>
			<s:hidden name="renovation.renostate" title="办理状态"></s:hidden>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="renovation.reporttime" value="<s:property value="renovation.reporttime" />"
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<img alt="暂无图片" id="myimage1" width="150px" height="80px" src="<%=basePath%>${renovation.image1}"/>
					<script type="text/javascript">
															function change1() {
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<img alt="暂无图片" id="myimage2" width="150px" height="80px" src="<%=basePath%>${renovation.image2}"/>
					<script type="text/javascript">
															function change2() {
