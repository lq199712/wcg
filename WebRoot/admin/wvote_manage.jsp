...
<body>
	...
	<div class="alert alert-info">
	  	...
	  	<p><span class="bold">注意：</span>系统默认向用户显示,当前最新且有效的投票.</p>
	</div>
...
<div class="pagination">
 ...
 -->  
	...
	<table class="table table-bordered">
			...
			<tbody>
					<s:if test="%{wvoteVOs.size()==0}">
											<td colspan="8" align="center">
												暂无该信息
											</td>
								</s:if>
                                 <s:iterator value="wvoteVOs" var="wvote" status="index">
                                  <tr>
						<td>
						...
						<span>
						[
						<a href="wvoteAction!load?id=<s:property value="id"/>"> 修改/查看</a>
						]
						</span>
						<span>
						[
						<a href="wvoteAction!delete?id=<s:property value="id"/>" onclick="return confirm('你确定删除该信息吗？')"">删除</a>
						]
						</span>
						</td>
				  </tr>
