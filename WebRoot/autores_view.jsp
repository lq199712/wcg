...
<div class="linedwon"><img src="skin/images/frame/jiantou.gif" width="20" height="20" border="0">当前位置：功能管理&gt;&gt;查看自动回复&nbsp;</div>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="60" >
	...
	<td width="75%" align="left" style="padding-left: 50px;">
	  <label>
		<s:property value="autores.content" />
	  </label></td>
</tr>
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td height="29" align="center" valign="bottom">
    	<input type='button' class="coolbg np" onClick="window.location.href='autoresAction!load?id=<s:property value="autores.id"/>'" value='修改' style="width:80" />&nbsp;&nbsp;
      </td>
  </tr>
  <tr>
