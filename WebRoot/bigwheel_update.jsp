...
<body>
	...
	<form name="bigwheelform" class="form-horizontal" id="lbsForm" action="bigwheelAction!update" method="post" enctype="multipart/form-data">
		<s:hidden name="bigwheel.id"/>
		<s:hidden name="bigwheel.image" />
	...
	<div class="control-group">
		...
		<label class="control-label" for="">活动展示图片</label>
			<div class="controls">
		<s:file name="picture" src="<s:property value='bigwheel.image'/>" cssStyle="width:80%" onchange="change();" id="myfile"></s:file>
		<br/>
		...
		<table class="prizetable" style="margin-left: 80px;">
			...
			<tbody>
				<tr>
					<td>奖项一</td>
					<td>
					<s:textfield  name="bigwheel.prize1" id="xydzpj1mc" class="span3"/>
					</td>
					<td>
					<s:textfield  name="bigwheel.prizename1" id="xydzpj1ms" class="span3"/>
					</td>
					<td>
					<s:textfield  name="bigwheel.prizenumber1" id="xydzpj1sl"  class="span1"  isint="1"/>
					</td>
					<td>
					<s:textfield    name="bigwheel.prizeprob1" id="xydzpj1gl"  class="span1" isfloat="1" />
					</td>
				</tr>
				<tr>
					<td>奖项二</td>
					<td>
					<s:textfield  name="bigwheel.prize2" id="xydzpj1mc" noneed="1" class="span3"/>
					</td>
					<td>
					<s:textfield  name="bigwheel.prizename2" id="xydzpj1ms" noneed="1" class="span3"/>
					</td>
					<td>
					<s:textfield  name="bigwheel.prizenumber2" id="xydzpj1sl" noneed="1"  class="span1"  isint="1"/>
					</td>
					<td>
					<s:textfield  name="bigwheel.prizeprob2" id="xydzpj1gl"  isfloat="1" noneed="1" class="span1"/>
					</td>
				</tr>
				<tr>
					<td>奖项三</td>
					<td>
					<s:textfield  name="bigwheel.prize3" id="xydzpj1mc" noneed="1" class="span3"/>
					</td>
					<td>
					<s:textfield  name="bigwheel.prizename3" id="xydzpj1ms" noneed="1" class="span3"/>
					</td>
					<td>
					<s:textfield  name="bigwheel.prizenumber3" id="xydzpj1sl" noneed="1"  class="span1"  isint="1"/>
					</td>
					<td>
					<s:textfield   name="bigwheel.prizeprob3" id="xydzpj1gl"  isfloat="1" noneed="1" class="span1"/>
					</td>
				</tr>
				<!-- 
				<tr class="more" style="display:none;">
					<td>奖项四</td>
					<td>
					<s:textfield  name="bigwheel.prize4" id="xydzpj1mc" noneed="1" class="span3"/>
					</td>
					<td>
					<s:textfield  name="bigwheel.prizename4" id="xydzpj1ms" noneed="1" class="span3"/>
					</td>
					<td>
					<s:textfield  name="bigwheel.prizenumber4" id="xydzpj1sl" noneed="1"  class="span1"  isint="1"/>
					</td>
					<td>
					<s:textfield  name="bigwheel.prizeprob4" id="xydzpj1gl"  isfloat="1" noneed="1" class="span1"/>
					</td>
				</tr>
				<tr class="more" style="display:none;">
					<td>奖项五</td>
					<td>
					<s:textfield  name="bigwheel.prize5" id="xydzpj1mc" noneed="1" class="span3"/>
					</td>
					<td>
					<s:textfield  name="bigwheel.prizename5" id="xydzpj1ms" noneed="1" class="span3"/>
					</td>
					<td>
					<s:textfield  name="bigwheel.prizenumber5" id="xydzpj1sl" noneed="1"  class="span1"  isint="1"/>
					</td>
					<td>
					<s:textfield  name="bigwheel.prizeprob5" id="xydzpj1gl"  isfloat="1" noneed="1" class="span1"/>
					</td>
				</tr>
				<tr class="more" style="display:none;">
					<td>奖项六</td>
					<td>
					<s:textfield  name="bigwheel.prize6" id="xydzpj1mc" noneed="1" class="span3"/>
					</td>
					<td>
					<s:textfield  name="bigwheel.prizename6" id="xydzpj1ms" noneed="1" class="span3"/>
					</td>
					<td>
					<s:textfield  name="bigwheel.prizenumber6" id="xydzpj1sl" noneed="1"  class="span1"  isint="1"/>
					</td>
					<td>
					<s:textfield  name="bigwheel.prizeprob6" id="xydzpj1gl"  isfloat="1" noneed="1" class="span1"/>
					</td>
				</tr>
			...
			<div class="form-horizontal">
			  <div class="control-group">
			   <label class="control-label" for="showamount">是否显示奖品数量</label>
			     <div class="controls" >
			    	<s:select  list="#{1:'显示',0:'不显示'}" name="bigwheel.isshownum" listKey="key" listValue="value"/>
			      	<span class="help-inline">选择显示后在活动页面中将会显示奖品数量</span>
			    </div>
			  </div>
			  <div class="control-group">
			   <label class="control-label" for="state">活动状态</label>
			    <div class="controls" >
			    	<s:select   list="#{0:'准备中',1:'进行中',2:'活动已结束'}" name="bigwheel.currentstate" listKey="key" listValue="value"/>
			    </div>
			  </div>
			  <div class="control-group">
			    <label class="control-label" for="playtotal">每人参与的总次数</label>
			    <div class="controls">
			    	<s:textfield  name="bigwheel.totimes" id="xydzpmrzs" class="span1" isint="1"/>
			    </div>
			  </div>
			  <!--  
			  <div class="control-group">
			    ...
			    <div class="controls">
			    	<s:textfield  name="bigwheel.maxnumofprizes" id="xydzpmrzd" class="span1" isint="1"/>
