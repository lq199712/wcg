...
<div class="linedwon"><img src="skin/images/frame/jiantou.gif" width="20" height="20" border="0">当前位置：回复功能&gt;&gt;新增菜单&nbsp;<a href="javascript:history.back();" style=" color:red;">[返回]</a></div>
  
<!--  内容列表   -->
<form name="form2" action="custommenuAction!add" method="post" >

<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
<tr bgcolor="#DD605E">
	<td height="33" colspan="4" align="center"><strong>新增菜单</strong>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
	...
	<td width="30%" align="left">
		...
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu1son5type" listKey="key" listValue="value" value="'click'"></s:radio><br>
	...
	<td width="30%" align="left">
		...
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu2son5type" listKey="key" listValue="value" value="'click'"></s:radio><br>
	...
	<td width="30%" align="left">
		...
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu3son5type" listKey="key" listValue="value" value="'click'"></s:radio><br>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
	...
	<td width="30%" align="left">
		...
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu1son4type" listKey="key" listValue="value" value="'click'"></s:radio><br>
	...
	<td width="30%" align="left">
		...
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu2son4type" listKey="key" listValue="value" value="'click'"></s:radio><br>
	...
	<td width="30%" align="left">
		...
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu3son4type" listKey="key" listValue="value" value="'click'"></s:radio><br>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
	...
	<td width="30%" align="left">
		...
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu1son3type" listKey="key" listValue="value" value="'click'"></s:radio><br>
	...
	<td width="30%" align="left">
		...
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu2son3type" listKey="key" listValue="value" value="'click'"></s:radio><br>
	...
	<td width="30%" align="left">
		...
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu3son3type" listKey="key" listValue="value" value="'click'"></s:radio><br>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
	...
	<td width="30%" align="left">
		...
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu1son2type" listKey="key" listValue="value" value="'click'"></s:radio><br>
	...
	<td width="30%" align="left">
		...
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu2son2type" listKey="key" listValue="value" value="'click'"></s:radio><br>
	...
	<td width="30%" align="left">
		...
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu3son2type" listKey="key" listValue="value" value="'click'"></s:radio><br>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
	...
	<td width="30%" align="left">
		...
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu1son1type" listKey="key" listValue="value" value="'click'"></s:radio><br>
	...
	<td width="30%" align="left">
		...
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu2son1type" listKey="key" listValue="value" value="'click'"></s:radio><br>
	...
	<td width="30%" align="left">
		...
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu3son1type" listKey="key" listValue="value" value="'click'"></s:radio><br>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
	...
	<td width="30%" align="left">
		<s:radio list="#{'1':'是','0':'否'}" name="custommenu.isend1" listKey="key" listValue="value" value="1"></s:radio><br>
		<s:textfield name="custommenu.menu1key" cssStyle="width:98%"></s:textfield><br>
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu1type" listKey="key" listValue="value" value="'click'"></s:radio><br>
	...
	<td width="30%" align="left">
		<s:radio list="#{'1':'是','0':'否'}" name="custommenu.isend2" listKey="key" listValue="value" value="1"></s:radio><br>
		<s:textfield name="custommenu.menu2key" cssStyle="width:98%"></s:textfield><br>
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu2type" listKey="key" listValue="value" value="'click'"></s:radio><br>
	...
	<td width="30%" align="left">
		<s:radio list="#{'1':'是','0':'否'}" name="custommenu.isend3" listKey="key" listValue="value" value="1"></s:radio><br>
		<s:textfield name="custommenu.menu3key" cssStyle="width:98%"></s:textfield><br>
		<s:radio list="#{'click':'回复信息','view':'网页跳转'}" name="custommenu.menu3type" listKey="key" listValue="value" value="'click'"></s:radio><br>
