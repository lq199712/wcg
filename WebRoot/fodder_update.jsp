	...
	<body leftmargin="8" topmargin="8">
		<div class="linedwon">
			...
			<a
				...
				target='main'>素材管理</a>&gt;&gt;修改素材&nbsp;
			<a href="javascript:history.back();" style="color: red;">[返回]</a>
		</div>

		<!--  内容列表   -->
		<form name="form2" action="fodderAction!update" method="post"
			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1"
				...
				<tr bgcolor="#E7E7E7">
					<td height="33" colspan="2" align="center">
						...
						<s:hidden name="fodder.funcflag"></s:hidden>
						<s:hidden name="fodder.articlecount"></s:hidden>
				...
				<tr align='center' bgcolor="#FFFFFF"
					...
					<s:elseif test="fodder.savetype==6">
					图文
					</s:elseif>
						...
						<td width="75%" align="left">
							<label>
								...
								<s:file name="picture" cssStyle="width:80%" onchange="change();" title="上传"
									id="myfile"></s:file>
								<br/>
								<img alt="暂无图片" src="<s:property value="fodder.picurl"/>" id="myimage" width="80%">
