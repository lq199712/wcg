...
<a href="fodderarticleAction!list?fodderid=<s:property value="%{#request.fodder.id}" />">子图文列表管理</a>&gt;&gt;修改子图文&nbsp;<a href="javascript:history.back();" style=" color:red;">[返回]</a></div>
  
<!--  内容列表   -->
<form name="form2" action="fodderarticleAction!update" method="post"  enctype="multipart/form-data" >

<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
<tr bgcolor="#E7E7E7">
	<td height="33" colspan="2" align="center"><strong>修改子图文</strong>
		<s:hidden name="fodderarticle.id"></s:hidden>
						...
						<td width="75%" align="left">
							<label>
								...
								<s:file name="picture" cssStyle="width:80%" onchange="change();" title="上传"
									id="myfile"></s:file>
								<br/>
								<img alt="暂无图片" src="<s:property value="fodderarticle.picurl"/>" id="myimage" width="80%">
