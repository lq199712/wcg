...
<script src="front/libs/jquery-2.1.0.min.js" type="text/javascript"></script>
        ...
        <!--  business css -- start -->
        <link href="front/css/page-menu.css" rel="stylesheet" type="text/css" />
        <!--  business css -- end -->
    </head>

    <body>
        <div class="am-app">
            <!--  stores.storeSignin -- start -->
            <div class="am-page page-menu" id="service_menu">
                <div class="am-header">
                    <p>服务指南</p>
                    ...
                    <div class="am-body-inner">
                        <ul class="menu-list">
                            	<s:if test="%{pagearticles.size()==0}">
									<li class="empty">现在没有服务信息!</li>
								</s:if>
								<s:iterator value="pagearticles" var="pagearticle">
	                                <li style="display:none">
	                                    <div onvclick="location.href='pagearticleAction!frontview2?id=<s:property value="id"/>&frontpa=<s:property value="frontpa"/>'" class="content">
	                                        <div class="img">
...
<script type="text/javascript">
$(function(){
	amGloble.waterfall($("ul.menu-list"));
});
