  	...
  	<li data-role="list-divider" data-theme="b">局领导</li>
  		<s:iterator value="addressbooks" var="addressbook" status="status">	 
  		  <s:if test="lochus=='局领导'">
  		 	  <li><a href="tel:<s:property value="mobileshortnumber"/> "><s:property value="lochus"/>-<s:property value="name"/> <span class="ui-li-aside"><s:property value="mobiletelphone"/>&nbsp;&nbsp;<s:property value="mobileshortnumber"/></span>  </a>  </li>
  		 	     </s:if>
    	</s:iterator>
