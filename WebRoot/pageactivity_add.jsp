...
<div class="linedwon"><img src="skin/images/frame/jiantou.gif" width="20" height="20" border="0">当前位置：微官网&gt;&gt;<a href='pagearticleAction!list1?publicaccount=${pubclient.publicaccount }&status=1' target='main'>活动管理</a>&gt;&gt;新增活动&nbsp;<a href="javascript:history.back();" style=" color:red;">[返回]</a></div>
  
<!--  内容列表   -->
<form name="form2" action="pagearticleAction!add1" method="post"  enctype="multipart/form-data" >

<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
<tr bgcolor="#E7E7E7">
	<td height="33" colspan="2" align="center"><strong>新增活动</strong>
		<s:hidden name="pagearticle.articletype" value="1"></s:hidden>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
  ...
  <td align="left">
  	<s:select list="#{1:'启用',0:'不启用'}" name="pagearticle.isshow" listKey="key" listValue="value"></s:select>
</td>
</tr>
