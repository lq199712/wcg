...
<div class="linedwon"><img src="skin/images/frame/jiantou.gif" width="20" height="20" border="0">当前位置：微官网&gt;&gt;<a href='pagearticleAction!list4?publicaccount=${pubclient.publicaccount }&status=4' target='main'>头版文章管理</a>&gt;&gt;修改头版文章&nbsp;<a href="javascript:history.back();" style=" color:red;">[返回]</a></div>
  
<!--  内容列表   -->
<form name="form2" action="pagearticleAction!update4" method="post"  enctype="multipart/form-data" >

<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
<tr bgcolor="#E7E7E7">
	<td height="33" colspan="2" align="center"><strong>修改头版文章</strong>
		<s:hidden name="pagearticle.id"></s:hidden>
		<s:hidden name="pagearticle.image"></s:hidden>
		<s:hidden name="pagearticle.articletype"></s:hidden>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
  ...
  <td align="left">
  	<s:select list="sontypes" name="pagearticle.sontype.id" listKey="id" listValue="name" value="4"></s:select>
</td>
</tr>

<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
	<td width="10%" height="25" align="right"><strong><font color="#333333">文章标题</font></strong></td>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
	<td  height="25" align="right"><strong><font color="#333333">标题缩写</font></strong></td>
	<td  align="left">
	  <label>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
	...
	<td  align="left">
	  <label>
		...
		<img alt="暂无图片" src="<s:property value="pagearticle.image"/>" id="myimage" width="400px">
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
	<td height="25" align="right"><strong><font color="#333333">头版文章链接</font></strong></td>
	<td align="left">
	  <label>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
	<td  height="25" align="right"><strong><font color="#333333">正文描述</font></strong></td>
	<td  align="left">
	  <label>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
  ...
  <td align="left">
  	<s:select list="#{2:'头版文章',1:'启用',0:'不启用'}" name="pagearticle.isshow" listKey="key" listValue="value"></s:select>
</td>
</tr>
