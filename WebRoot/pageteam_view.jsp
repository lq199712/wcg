...
<div class="linedwon"><img src="skin/images/frame/jiantou.gif" width="20" height="20" border="0">当前位置：微官网&gt;&gt;<a href='pagearticleAction!list3?publicaccount=${pubclient.publicaccount }&status=3' target='main'>设计师团队管理</a>&gt;&gt;查看设计师团队&nbsp;<a href="javascript:history.back();" style=" color:red;">[返回]</a></div>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="60" >
	<td height="25" align="right" style="padding-right: 50px;"><strong><font color="#333333">设计师名称</font></strong></td>
	<td align="left" style="padding-left: 50px;">
	  <label>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="60" >
	<td height="25" align="right" style="padding-right: 50px;"><strong><font color="#333333">职务</font></strong></td>
	<td align="left" style="padding-left: 50px;">
	  <label>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="60" >
	<td height="25" align="right" style="padding-right: 50px;"><strong><font color="#333333">预约号码</font></strong></td>
	<td align="left" style="padding-left: 50px;">
	  <label>
		<s:property value="pagearticle.pphone" />
	  </label></td>
</tr>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="60" >
	<td height="25" align="right" style="padding-right: 50px;"><strong><font color="#333333">设计师团队链接</font></strong></td>
	<td align="left" style="padding-left: 50px;">
	  <label>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="60" >
	<td height="25" align="right" style="padding-right: 50px;"><strong><font color="#333333">设计师介绍</font></strong></td>
	<td align="left" style="padding-left: 50px;">
	  <label>
