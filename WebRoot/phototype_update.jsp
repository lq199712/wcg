...
<div class="linedwon"><img src="skin/images/frame/jiantou.gif" width="20" height="20" border="0">当前位置：微相册&gt;&gt;<a href='phototypeAction!list?publicaccount=${pubclient.publicaccount }' target='main'>相册类别管理</a>&gt;&gt;修改相册类别&nbsp;<a href="javascript:history.back();" style=" color:red;">[返回]</a></div>
  
<!--  内容列表   -->
<form name="form2" action="phototypeAction!update" method="post"  enctype="multipart/form-data" >

<table width="50%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
<tr bgcolor="#E7E7E7">
	<td height="33" colspan="2" align="center"><strong>修改相册类别</strong>
		<s:hidden name="phototype.id"/>
