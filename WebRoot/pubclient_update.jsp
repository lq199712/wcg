...
<div class="linedwon"><img src="skin/images/frame/jiantou.gif" width="20" height="20" border="0">当前位置：公众平台管理&gt;&gt;<a href='pubclientAction!list' target='main'>公众账号管理</a>&gt;&gt;修改公众账号&nbsp;<a href="javascript:history.back();" style=" color:red;">[返回]</a></div>
  
<!--  内容列表   -->
<form name="form2" action="pubclientAction!update" method="post">

<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
<tr bgcolor="#E7E7E7">
	<td height="33" colspan="2" align="center">
	<s:hidden name="pubclient.id"/>
	<s:hidden name="pubclient.createdate"/>
	<s:hidden name="pubclient.password"/>
	<strong>修改公众账号</strong></td>
</tr>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
  ...
  <td align="left">
  	<s:select list="#{1:'模板1',2:'模板2',3:'模板3'}" name="pubclient.template" listKey="key" listValue="value" ></s:select>
</td>
</tr>
