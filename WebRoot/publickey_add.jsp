...
<div class="linedwon"><img src="skin/images/frame/jiantou.gif" width="20" height="20" border="0">当前位置：功能管理&gt;&gt;新增关键词标题&nbsp;</div>
  
<!--  内容列表   -->
<form name="form2" action="publickeyAction!add" method="post" >

<table width="50%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
<tr bgcolor="#E7E7E7">
	<td height="33" colspan="2" align="center"><strong>新增关键词标题</strong>
