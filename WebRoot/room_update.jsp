...
<div class="linedwon"><img src="skin/images/frame/jiantou.gif" width="20" height="20" border="0">当前位置：微酒店&gt;&gt;<a href='roomAction!list?publicaccount=${pubclient.publicaccount }' target='main'>客房管理</a>&gt;&gt;修改客房&nbsp;<a href="javascript:history.back();" style=" color:red;">[返回]</a></div>
  
<!--  内容列表   -->
<form name="form2" action="roomAction!update" method="post"  enctype="multipart/form-data" >

<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
<tr bgcolor="#E7E7E7">
	<td height="33" colspan="2" align="center"><strong>修改客房</strong>
		<s:hidden name="room.id"/>
		<s:hidden name="room.image" />
	</td>
</tr>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
	...
	<td width="75%" align="left">
	  <label>
		...
		<img alt="暂无图片" src="<s:property value='room.image'/>" id="myimage" width="80%">
