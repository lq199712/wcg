...
<!--<ul class="round">
			...
			<ul class="round">
				<form action="infApplyAction!queryInfApply" method="post" id="theform">
				<li class="title mb"><span class="none">请填写相关信息</span></li>
					...
					<li class="nob">
						<table class="kuang" border="0" cellpadding="0" cellspacing="0" width="100%">
							<tbody><tr>
								<th>相关信息</th>
								<td><input type="text"   value="" name="spnumber" id="newyy_recordform0" class="px" placeholder="请输入内容"/></td>
							</tr>
						</tbody></table>
					</li>
			...
			<div class="footReturn">
				<a id="showcard" class="submit" href="javascript:document.getElementById('theform').submit();">查询</a>
