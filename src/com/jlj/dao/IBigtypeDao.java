...
public interface IBigtypeDao {
	 ...
	 * 保存一条记录
	 */
	public abstract void save(Bigtype bigtype);
	 ...
	 * 根据hql语句来查询所有记录
	 */
	public abstract List<Bigtype> queryList(String queryString);

	/* (non-Javadoc)
	 * @see com.jlj.dao.imp.IBigtypeDao#getObjectsByCondition(java.lang.String, java.lang.Object[])
	 * 根据hql、条件值查询某些记录
	 */
	public abstract List<Bigtype> getObjectsByCondition(String queryString,
			Object[] p);
	 ...
	 * 根据hql、id列表查询某些记录
	 */
	public abstract List<Bigtype> getObjectsByIdList(final String hql,
	 ...
	 */
	public abstract List<Bigtype> pageList(final String queryString,
	 ...
	 * 根据hql语句、条件、值来查询一条记录
	 */
	public abstract Bigtype queryByNamedParam(String queryString,
			String[] paramNames, Object[] values);
